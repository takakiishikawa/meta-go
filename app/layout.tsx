  ...
  return (
    ...
    >
      <head>
        ...
        <style dangerouslySetInnerHTML={{ __html: `:root{--sidebar-accent:220 60% 94%;--sidebar-accent-foreground:226 71% 34%}.dark{--sidebar-accent:226 45% 18%;--sidebar-accent-foreground:226 60% 78%}` }} />
      </head>
